                ...
                <div class="quizz">
                    ...
                    <div class="partieAdmin">
                            ...
                            <div class="tableau-bord-Admin" >
                                <div class="liste question"><a href="index.php?page=admin&menu=listequestion">Liste Questions<img src="Images/ic-liste.png"/></a> </div>
                                <div class="liste creerAdmin"><a href="index.php?page=admin&menu=creeradmin">Créer Admin<img src="Images/ic-ajout.png"/></a></div>
                                <div class="liste joueurs" ><a href="index.php?page=admin&menu=listejoueur">Listes joueurs<img src="Images/ic-liste.png"/></a></div>
                                <div class="liste creerquestions"><a href="index.php?page=admin&menu=creerquestion">Créer Questions <img src="Images/ic-ajout.png"/></a></div>
...
<script>
       function active(t){
        ...
        if(page == "listejoueur"){
             ...
             document.querySelector('.joueurs img').src="Images/ic-liste-active.png"
             active(pj)
        }
        if(page== "listequestion"){
             var pj =document.querySelector('.question')
             document.querySelector('.question img').src="Images/ic-liste-active.png"
             active(pj)
        }
        if(page== "creerquestion"){
             var pj =document.querySelector('.creerquestions')
             document.querySelector('.creerquestions img').src="Images/ic-ajout-active.png"
             active(pj)
        }
        if(page== "creeradmin"){
             var pj =document.querySelector('.creerAdmin')
             document.querySelector('.creerAdmin img').src="Images/ic-ajout-active.png"
